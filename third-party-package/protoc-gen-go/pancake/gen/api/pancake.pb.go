...
func (*UnimplementedPancakeBakerServiceServer) Bake(ctx context.Context, req *BakeRequest) (*BakeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Bake not implemented")
}
func (*UnimplementedPancakeBakerServiceServer) Report(ctx context.Context, req *ReportRequest) (*ReportResponse, error) {
